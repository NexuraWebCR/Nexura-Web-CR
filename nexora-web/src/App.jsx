          ...
          <div className="grid grid-cols-2 gap-6">
            {metrics.map((metric, i) => (
              <motion.div
                ...
                className="relative bg-slate-950/30 border border-slate-800/80 rounded-3xl p-6 text-center hover:border-cyan-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-950/10 group overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/[0.01] to-white/[0.02] rounded-3xl pointer-events-none"></div>
                
                <h4 className="text-4xl md:text-5xl font-black tracking-tight text-cyan-400 mb-2 group-hover:scale-105 transition-transform duration-300">
                  {metric.value}
                </h4>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 bg-slate-950/60 border border-slate-900 rounded-2xl p-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@nexorawebcr.com" className="text-sm font-semibold text-slate-200 hover:text-purple-400 transition-colors">info@nexorawebcr.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-slate-950/60 border border-slate-900 rounded-2xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-slate-200">San José, Costa Rica</p>
                  </div>
                </div>
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="relative w-14 h-14 bg-[#25d366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-108 transition-all duration-300 shadow-[#25d366]/20">
            ...
            >
              <path d="M12.004 2c-5.518 0-9.998 4.479-9.998 9.997 0 1.862.511 3.6 1.405 5.093l-1.405 5.143 5.273-1.385A9.945 9.945 0 0012.004 22c5.518 0 9.998-4.479 9.998-9.997S17.522 2 12.004 2zm0 1.666c4.594 0 8.332 3.738 8.332 8.331s-3.738 8.331-8.332 8.331a8.27 8.27 0 01-4.227-1.157l-.304-.18-3.136.823.838-3.067-.197-.315a8.277 8.277 0 01-1.306-4.431c0-4.593 3.738-8.331 8.332-8.331zm-2.457 3.328c-.225 0-.435.086-.59.24-.155.155-.327.391-.327.854 0 .927.674 1.82 1.488 2.502.814.683 2.164 1.802 3.864 2.392.484.168.916.273 1.258.354.498.115.952.099 1.312.045.402-.06 1.238-.507 1.412-.996.175-.489.175-.909.124-.996-.051-.086-.19-.137-.4-.239-.21-.102-1.238-.611-1.429-.68-.19-.068-.328-.102-.468.102-.139.204-.54.68-.661.82-.121.139-.243.155-.453.053-.21-.102-.888-.327-1.693-1.047-.626-.559-1.049-1.25-1.171-1.46-.122-.21-.013-.323.092-.426.095-.092.21-.24.316-.36.105-.12.14-.204.21-.34.07-.137.035-.256-.017-.358-.053-.102-.468-1.129-.643-1.55-.17-.411-.358-.354-.49-.354z"/>
            </svg>
          </div>
        </div>
